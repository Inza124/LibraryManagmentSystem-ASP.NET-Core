...
{
    public partial class initialentitydatamodels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayOfWekk = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookIndex = table.Column<string>(nullable: true),
                    ISBN = table.Column<int>(nullable: true),
                    Comic_Author = table.Column<string>(nullable: true),
                    ...
                    Magazine_Number = table.Column<int>(nullable: true),
                    Publisher = table.Column<string>(nullable: true),
                    Series = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_LibraryBranchId",
                table: "Clients",
                column: "LibraryBranchId");

            migrationBuilder.CreateIndex(
                name: "IX_Clients_LibraryCardId",
                table: "Clients",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Clients_LibraryBranches_LibraryBranchId",
                table: "Clients",
                column: "LibraryBranchId",
                principalTable: "LibraryBranches",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Clients_LibraryCards_LibraryCardId",
                table: "Clients",
                column: "LibraryCardId",
                principalTable: "LibraryCards",
                principalColumn: "Id",
